        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header "style="margin-bottom:20px;">
              ...
              <h3 class="card-title" style="display:inline;">photo Gallery </h3>
               <a style="display:inline;left:25%px;" href="{{ route('photoGallery.create') }}"
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('photoGallery.get_data')}}';
            $('#example1').DataTable({
       ...
       {data: "DT_RowIndex", name: 'DT_RowIndex'},
                    ...
                    {data: "description", name: 'occupation'},
