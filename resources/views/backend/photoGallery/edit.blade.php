...
<div class="container float-center"
    ...
    <div class="row">
        <div class="col-12">
            ...
            <h2 style="display:inline">edit photo gallery</h2>
   ...
   {!! Form::model($photoGallery, ['method' => 'PUT', 'route' => ['photoGallery.update', $photoGallery->id], 'files' => true,]) !!}
